<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_Order.aspx.cs" Inherits="WebApplication7.Admin_Order" %>
...
ol.progtrckr[data-progtrckr-steps="6"] li { width: 9%; }
...
<%--        <li><asp:HyperLink class="navbar-brand" ID="HyperLink1" runat="server" Font-Size="Small" NavigateUrl="~/Attendance.aspx">ATTENDANCE</asp:HyperLink> </li>
 ...
 --><li id="loaded" class="progtrckr-todo" runat="server">Loaded </li>
       ...
       <asp:Button ID="btShowAll" runat="server" Text="Done" 
            onclick="btShowAll_Click" Visible="false" class="btn btn-primary"/>
        &nbsp;&nbsp;&nbsp;<br />
        <br />
     
     <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="false" alternatingrowstyle-cssclass="space" rowstyle-cssclass="space" OnRowCommand="Tracking" >
        <Columns>
          <asp:ImageField HeaderText="" DataImageUrlField="image" ControlStyle-Width="100"  ControlStyle-Height="100" />
          <asp:BoundField HeaderText="" DataField="image" Visible="false" />
          <asp:BoundField HeaderText=""  DataField="type" ItemStyle-Width="190px" ItemStyle-ForeColor="Black" ItemStyle-VerticalAlign="NotSet" ItemStyle-HorizontalAlign="Justify" />
          <asp:BoundField HeaderText=""  DataField="size" ItemStyle-Width="190px"/>
          <asp:BoundField HeaderText="" DataField="price" ItemStyle-Width="190px"/>
          <asp:BoundField HeaderText="" DataField="orderDate" ItemStyle-Width="190px"/>
          <asp:BoundField HeaderText="" DataField="ship_address" ItemStyle-Width="190px"/>
